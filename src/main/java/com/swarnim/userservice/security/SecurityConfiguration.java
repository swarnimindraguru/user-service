package com.swarnim.userservice.security;
...
//                .username("user")
//                .password("$2a$12$5jNhr0eUdX96DZnVbxZX/OVRrqeQ1XOIuBwgwTqxGyOnt3PFCiJ.G") //hashCode of password as it is using bcrypt password encoder internally
//                .roles("USER")
//                .build();
//
